[//]: <> (starter-react4xp readme: USE THIS FILE TO EDIT THE ROOT's README.md! This will generate actual README.md and README.adoc with placeholder values inserted, on commit. Gradle task: copyReadme. Version placeholders: ###STARTER_VERSION###, ###XP_VERSION###, ###LIB_VERSION### and ###NPM_BUNDLE_VERSION###. Leave this line in place! )
